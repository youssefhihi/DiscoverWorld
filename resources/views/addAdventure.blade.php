...
@include('inc.nav')
    <div class="mx-auto pt-28 p-20 ">
        <h1 class="text-3xl text-center font-semibold font-italic mb-6">Add New Adventure</h1>
            ...
            <form action="{{route('addAdventure')}}" method="POST" class=" mx-auto bg-white p-6 rounded-md w-full" enctype="multipart/form-data">
            @csrf            <!-- Adventure Title -->
                ...
                <!-- Picture Upload -->
                <div class="mb-4">
                    <label for="picture" class="block text-gray-700 font-bold mb-2">Upload Pictures</label>
                    <input type="file" name="pictures[]" multiple class="w-full p-2 border-b-2 border-black focus:outline-none focus:border-blue-500">
                </div>
                <!-- Submit Button -->
